...
# Custom styles to enable 2-column layout on mobile
st.markdown("""
    <style>
    .card-row {
        display: flex;
...
st.title("📱 2-Column Mobile Card Layout")
...
# Demo card data
card_data = [
    {"title": "Card 1", "text": "Mobile-friendly card 1", "image": "https://placekitten.com/400/200", "key": "card1"},
    {"title": "Card 2", "text": "Mobile-friendly card 2", "image": "https://placekitten.com/401/200", "key": "card2"},
    {"title": "Card 3", "text": "Mobile-friendly card 3", "image": "https://placekitten.com/402/200", "key": "card3"},
    {"title": "Card 4", "text": "Mobile-friendly card 4", "image": "https://placekitten.com/403/200", "key": "card4"},
]

# Group all cards into a responsive div row
st.markdown('<div class="card-row">', unsafe_allow_html=True)

# Render each card inside its column
for item in card_data:
    ...
    result = card(
        ...
        styles={
            "card": {
                ...
                "height": "180px",
                "border-radius": "15px",
                "background": "linear-gradient(135deg, #4ECDC4, #ffffff)",
                "color": "black",
                "text-align": "center",
                "padding": "10px",
            ...
            "text": {"font-size": "14px", "margin": "5px 0 0 0"},
        }
    )
    if result:
        st.success(f"You clicked: {item['title']}")
