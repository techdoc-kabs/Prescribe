...
def create_connection():
    return sqlite3.connect("your_database.db")  # Replace with your actual DB path
    ...
    try:
        ...
        if result and result[0] > 0:
            ...
            cursor.execute(insert_query, (
                ...
                max_dose, max_prescribed_quantity, prescriber, cadre, current_timestamp
            ))
            conn.commit()
    ...
    if existing_prescription and existing_prescription[0]:
        ...
        if prescription_to_remove in existing_prescription_list:
            ...
            if updated_prescription:
                ...
                delete_query = "DELETE FROM prescriptions WHERE appointment_id = ?"
            ...
            st.warning(f"Prescription '{prescription_to_remove}' not found.")
    else:
